...
{
    ITEM_PICK_UP_CHOICE_TOGGLE                  ("tweakItemPickupChoice",                       false, "",    "If enabled, you can pick up only item you want");
    ...
    public String getComment()
    {
        ...
        {
            return comment + "\n" + StringUtils.translate("ITEM_PICK_UP_CHOICE.label.config_comment.single_player_only");
        }
    ...
    public void setValueFromJsonElement(JsonElement element)
    {
        try
        {
            ...
            {
                ItemPickupChoice.logger.warn("Failed to set config value for '{}' from the JSON element '{}'", this.getName(), element);
            }
        }
        catch (Exception e)
        {
            ItemPickupChoice.logger.warn("Failed to set config value for '{}' from the JSON element '{}'", this.getName(), element, e);
        }
    }
}
