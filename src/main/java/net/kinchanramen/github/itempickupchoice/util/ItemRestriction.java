    ...
    protected void setValuesForList(ListType type, List<String> names)
    {
        ...
        for (String name : names)
        {
            try
            {
                ...
                {
                    ItemPickupChoice.logger.warn("Invalid item name in a black- or whitelist: '{}", name);
                }
            }
            catch (Exception e)
            {
                ItemPickupChoice.logger.warn("Invalid item name in a black- or whitelist: '{}", name, e);
            }
        }
    }
